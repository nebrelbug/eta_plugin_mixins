  ...
  return {
    processAST: function (
      ...
      buff.unshift({
        t: "e",
        val:
          `function block(t,n){var i=${config.varName}[t];return i?"function"==typeof i?i(${config.varName}):i:"function"==typeof n?n(${config.varName}):n}function layout(t,n){if(n)return E.includeFile(t,n);tR.l=t}`,
      });
